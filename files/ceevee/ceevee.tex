...
\vspace{0.05in}
% Journal Articles
\cvitem{Journal Articles}{{[1] J. De Loera, \textbf{ E. Jaramillo Rodriguez}, D. Oliveros, and A. Torres Hernadez, ``A Model for Birdwatching and other Chronological Sampling Activities,'' arXiv:2205.05743  (2022). Scheduled to appear in \emph{The American Mathematical Monthly.}}}
\vspace{0.05in}
...
% Pre-Prints
\cvitem{Pre-Prints}{{[1] \textbf{ E. Jaramillo Rodriguez} ``Combinatorial Methods for Barcode Analysis,'' arXiv:2206.05613 (2022). }}
\vspace{0.05in}
% Conference Papers
\cvitem{Conference Papers}{[1] S. D. Han, \textbf{E. Jaramillo Rodriguez} and J. Yu, ``SEAR: A Polynomial- Time Multi-Robot Path Planning Algorithm with Expected Constant-Factor Optimality Guarantee,'' 2018 IEEE/RSJ International Conference on Intelligent Robots and Systems (2018), pp. 1-9.}
\vspace{0.05in}
