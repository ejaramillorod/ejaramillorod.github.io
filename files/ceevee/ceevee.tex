...
% Pre-Prints
\cvitem{Pre-Prints}{{[1] \textbf{ E. Jaramillo Rodriguez} ``Barcode Posets:
Combinatorial Properties and Connections,'' arXiv:2206.05613 (2022). }}
\vspace{0.05in}
\cvitem{}{{[2] J. De Loera, \textbf{ E. Jaramillo Rodriguez}, D. Oliveros, and A. Torres Hernadez, ``A Model for Birdwatching and other Chronological Sampling Activities,'' arXiv:2205.05743  (2022). Scheduled to appear in \emph{The American Mathematical Monthly.}}}
\vspace{0.05in}
...
{\textbf{Math 108: Introduction to Abstract Math}, Fall 2022, UC Davis. Lead Instructor: Orsola Capovilla-Searle.}
\cvitem{}
