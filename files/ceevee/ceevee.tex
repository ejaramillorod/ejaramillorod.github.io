...
% Pre-Prints
\cvitem{Submitted Articles}{{[1] J. De Loera, \textbf{ E. Jaramillo Rodriguez}, D. Oliveros, and A. Torres Hernadez, ``A Model for Birdwatching and other Chronological Sampling Activities,'' submitted for publication in The American Mathematical Monthly (2022). }}
\vspace{0.05in}
...
\cvitem{2021}
{Presenter, ``New Methods for Mixture Model Analysis'' with A. Chavez, J. De Loera,  J. Simental Rodr´ıguez, and A. Torres Hernandez, \textbf{AIM Latinx Mathematician Research Community Meeting}, Virtual (December 3, 2021).}
\vspace{0.05in}
\cvitem{}{Seminar Speaker, ``Coupon Collecting, Bird Watching, and other Chronological Sampling Activities: A Random Interval Graph Model'', \textbf{Graduate Student Research Seminar}, UC Davis Mathematics (April 1, 2021).}
\vspace{0.05in}
...
\section{Service}
\cvitem{Reviewer}{Boletín de la Sociedad Matemática Mexicana.}
